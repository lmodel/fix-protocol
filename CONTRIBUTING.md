# Contributing to fix-protocol

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
fix-protocol. These guidelines are not strict rules.
...
The fix-protocol team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the fix-protocol technical leads
...
[issues]: https://github.com/lmodel/fix-protocol/issues/
[pulls]: https://github.com/lmodel/fix-protocol/pulls/
